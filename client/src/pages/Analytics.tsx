  ...
  return (
    <div className="p-5 max-w-[1400px] space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-white" style={{fontFamily:"Syne,sans-serif"}}>Analytics Hub</h1>
          <p className="text-[11px] text-white/40">Google Analytics × TikTok Creator Studio × Business Intelligence</p>
        </div>
