...
export default function WalletPage() {
  ...
  return (
    <div className="p-5 max-w-[1200px] mx-auto space-y-4">
      ...
      {/* Total Balance Card */}
      <div className="rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 to-blue-600/5 p-5">
        <div className="flex items-start justify-between">
          <div>
            <div className="text-[11px] text-white/40 mb-1">Total Portfolio Value</div>
            <div className="text-4xl font-bold text-white font-mono">{formatCurrency(totalUSD)}</div>
