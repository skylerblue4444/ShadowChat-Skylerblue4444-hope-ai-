      ...
      <div className="w-60 shrink-0 border-r border-white/[0.06] flex flex-col"
        ...
        <div className="p-4 border-b border-white/[0.06]">
          <div className="flex items-center gap-2 mb-1">
            ...
            <div>
              <div className="text-[13px] font-bold text-white" style={{ fontFamily: "Syne, sans-serif" }}>HOPE AI</div>
              <div className="text-[9px] font-mono" style={{ color: `${persona.color}99` }}>{persona.name.toUpperCase()}</div>
            </div>
          </div>
          {isUnhinged && (
            <div className="mt-2 text-[9px] font-mono px-2 py-1 rounded border animate-pulse text-center"
