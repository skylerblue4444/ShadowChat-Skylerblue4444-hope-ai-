...
export default function AIEngineerIDE() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#0a0a1a] text-white overflow-hidden">
      {/* Top Bar */}
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/10 bg-[#0d0d20]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-white/40">
            {agents?.agents.length || 6} Agents • {health?.routers || 44} Routers • {health?.tests.passing || 43} Tests
          </span>
        </div>
