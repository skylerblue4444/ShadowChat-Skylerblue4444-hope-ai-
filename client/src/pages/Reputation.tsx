...
export default function Reputation() {
  return (
    <div className="p-5 max-w-[1000px] space-y-5">
      <div>
        <h1 className="text-xl font-bold text-white" style={{fontFamily:"Syne,sans-serif"}}>Reputation Engine</h1>
        <p className="text-[11px] text-white/40">Trust scores · Karma system · Behavioral credibility</p>
      </div>
