      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-white/40 mt-0.5">
            HOPE AI × ShadowChat × SKYCOIN4444 — Unified Operating System
          </p>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[10px] px-2 py-1 rounded border font-mono bg-green-500/10 text-green-400 border-green-500/20 flex items-center gap-1">
