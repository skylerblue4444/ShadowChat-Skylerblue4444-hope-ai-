  ...
  return (
    <div className="p-5 max-w-[1200px] space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-white" style={{fontFamily:"Syne,sans-serif"}}>Creator Studio</h1>
          <p className="text-[11px] text-white/40">TikTok Creator × YouTube Studio × AI Content Engine</p>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-amber-400 font-mono">$8,884 earned</span>
        </div>
      </div>
