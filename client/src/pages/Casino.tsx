  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-yellow-400 via-red-500 to-purple-500 bg-clip-text text-transparent">
          🎰 ShadowChat Casino
        </h1>
        <p className="text-zinc-400 mt-1">Provably Fair • AI Dealer • Crypto Bets</p>
      </div>
